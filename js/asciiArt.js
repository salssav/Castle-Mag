...
// SELECT ALL ELEMENTS THAT CONTAIN AN IMG WITH ID "draggable_element"
document.querySelectorAll('img#draggable_element').forEach((img) => {
    const parentDiv = img.parentElement;
    if (parentDiv) dragElement(parentDiv);
  });
